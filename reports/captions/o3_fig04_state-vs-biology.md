# o3_fig04_state-vs-biology

- **Objetivo:** O3
- **Decisión justificada:** Coherencia biológica validada: migración concentrada en pasos estacionales (mar-may, ago-oct) y latitudes intermedias
- **Figura:** `reports/figures/o3_fig04_state-vs-biology.png`
- **Tabla:** `reports/tables/o3_tab04_state-vs-biology.csv`
