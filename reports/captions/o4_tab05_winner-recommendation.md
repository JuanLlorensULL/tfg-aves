...
- **Objetivo:** O4
- **Decisión justificada:** Ganador poblacional = rf; ganador individual 91916A = rf. Criterio: log-loss.
- **Tabla:** `reports/tables/o4_tab05_winner-recommendation.csv`

## Caption (memoria)

**Criterio principal: log-loss** (calibración probabilística, heredado de O2). **Ganador poblacional (82 aves):** `rf` con log-loss = 5.488. **Ganador individual (91916A):** `rf` con log-loss = 4.327 (evaluado solo sobre 91916A). 
