...
\usepackage{booktabs} % reglas horizontales para tablas (\toprule, \midrule...)
\usepackage{multirow} % celdas de tabla que abarcan varias filas
\usepackage{graphicx} % inclusión de figuras (.pdf, .png)
\graphicspath{{figuras/}{../../figures/}} % diagramas propios y artefactos de reports/figures
\usepackage{float} % colocación fija de figuras/tablas con [H]
...
\input{secciones/desarrollo_o1}

\input{secciones/desarrollo_o2}

\input{secciones/desarrollo_o3}

\input{secciones/desarrollo_o4}

\input{secciones/desarrollo_o5}
