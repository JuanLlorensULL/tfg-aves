...
distintos (días de residencia casi inmóvil y días de migración de cientos de
kilómetros) y porque cada ave sigue su propia ruta, de modo que un patrón
...
de comportamiento no observado (residente o en migración), y ese estado alimenta,
...
\begin{enumerate}
  ...
  \item Detectar el régimen de comportamiento de cada día (residente o en
