...
\begin{figure}[H]
  ...
  \caption[Canalización de preparación de datos de O1]{Canalización de
...
\begin{table}[H]
  ...
  formato Movebank conservadas en O1, con su nombre en el proyecto y su uso. El
...
que se concentra el muestreo (05:00, 08:00, 14:00 y 20:00 UTC, ya anticipadas en la
sección \ref{sec:o1-caracterizacion}), de volumen casi idéntico (entre 15\,466 y
...
África occidental (figura \ref{fig:o1-spatial}). Esta extensión fija el dominio que
la cadena de Markov deberá discretizar: la rejilla de celdas ha de abarcar desde las
latitudes nórdicas hasta el África occidental.
...
\begin{figure}[H]
  ...
  migratorio de \textit{Larus fuscus} entre el norte de Europa y el África
  occidental.}
...
parte de la muestra. Queda abierta para O2 una decisión: entrenar sobre todas las
rachas o exigir una longitud mínima.
